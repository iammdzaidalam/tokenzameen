...
export function LocationSection({ project, index }: { project: Project; index: string }) {
          ...
          <div className="flex flex-col gap-4">
            {connectivity.length > 0 ? (
              ...
              <PendingPanel
                ...
                action={
                  <RequestButton subject="the location pack" variant="solid">
            ...
            {location.cities.length > 0 ? (
              <div className="rounded-card border border-[color:var(--hairline)] bg-[color:var(--surface)] p-4">
